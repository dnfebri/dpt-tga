@extends('layout/template', ['title' => 'Tambah Desa', 'nav' => 'Desa'])
                  ...
                  <div class="mb-3 row">
                     ...
                     <div class="col-sm-10">
                        <input type="text" class="form-control @error('nama_desa') is-invalid @enderror" id="nama_desa"
                           name="nama_desa" value="{{ old('nama_desa') }}" placeholder="Nama Desa">
                        @error('nama_desa')
                  ...
                  <div class="mb-3 row">
                     ...
                     <div class="col-sm-10">
                        <input type="text" class="form-control @error('jml_tps') is-invalid @enderror" id="jml_tps"
                           name="jml_tps" value="{{ old('jml_tps') }}" placeholder="Jumalah TPS">
                        @error('jml_tps')
